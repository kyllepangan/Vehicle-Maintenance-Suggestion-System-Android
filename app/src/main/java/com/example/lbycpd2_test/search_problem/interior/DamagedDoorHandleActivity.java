package com.example.lbycpd2_test.search_problem.interior;
...
public class DamagedDoorHandleActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_damageddoorhandle);
        setTitle("Damaged Door Handle");
    }
