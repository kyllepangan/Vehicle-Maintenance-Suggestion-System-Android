package com.example.lbycpd2_test.search_problem.others;
...
public class UpgradingWarrantyActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_upgradingwarranty);
        setTitle("Upgrading Warranty");
    }
