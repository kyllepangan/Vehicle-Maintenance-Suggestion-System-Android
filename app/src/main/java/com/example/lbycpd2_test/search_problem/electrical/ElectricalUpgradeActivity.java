package com.example.lbycpd2_test.search_problem.electrical;
...
public class ElectricalUpgradeActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_electricalupgrade);
        setTitle("Warranty on Electrical Upgrades");
    }
