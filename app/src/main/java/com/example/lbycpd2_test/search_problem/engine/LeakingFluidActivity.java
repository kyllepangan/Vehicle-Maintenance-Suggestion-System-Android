package com.example.lbycpd2_test.search_problem.engine;
...
public class LeakingFluidActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leakingfluid);
        setTitle("Leaking Fluid under Engine Bay");
    }
